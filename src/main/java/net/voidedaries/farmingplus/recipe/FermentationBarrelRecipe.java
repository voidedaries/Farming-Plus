...
public class FermentationBarrelRecipe implements Recipe<SimpleInventory> {
    private final ItemStack output;
    private final List<Ingredient> recipeItems;

    public FermentationBarrelRecipe(List<Ingredient> ingredients, ItemStack itemStack) {
